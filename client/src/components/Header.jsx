...
sm:max-w-[590px] mx-auto mt-10 text-center'>Turn text to
...
>Unleash your creativity with AI. Turn your imagination into 
visual art in seconds - just type, and watch the magic 
happen.</motion.p>
...
<motion.div
  ...
  {Array(6).fill('').map((item, index)=>(
    <motion.img
      ...
      src={index % 2 === 0 ? assets.sample_img_2 : assets.
      sample_img_1}
...
<motion.p
  ...
  className='mt-2 text-neutral-600'>Generated images from
imagify</motion.p>
